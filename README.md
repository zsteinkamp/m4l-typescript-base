...
Provides a starting point for a Typescript-based development environment for Max projects that use Javascript objects like `js` and `jsui`. Uses Docker and a VSCode devcontainer for the heavy lifting, thus eliminating the need to manage a build toolchain on your dev machine.
